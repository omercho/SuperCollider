...
'methods': [ "_-do","_-++","_-reshape","_-windex","_-wrapExtend","_-asCompileString","_-stutter","_-addFirst","_-asRawOSC","_-clipExtend","_-wrapPut","_-foldAt","_-clipPut","_-mirror2","_-pyramidg","_-source","_-asString","_-at","_-pyramid","_-addAll","_-multiChannelExpand","_-containsSeqColl","_-normalizeSum","_-scramble","_-mirror1","_-unbubble","_-slide","_-bubble","_-size","_-atIdentityHashInPairs","_-insert","_-add","_-allTuples","_-put","_-atIdentityHash","_-permute","_-flop","_-powerset","_-dpoll","_-mirror","_-envirPairs","_-slice","_-overWrite","_-rotate","_-normalize","_-reverse","_-replace","_-isValidUGenInput","_-foldPut","_-reverseDo","_-wrapAt","_-removeAt","_-foldExtend","_-collect","_-swap","_-lace","_-shift","_-clipAt","_-deepCollect","_-sputter","_-fork","_-plot","_*geom","_*rand2","_*fib","_*fill","_*interpolation","_*rand","_*linrand","_*new","_*exprand","_*fillND","_*fill2D","_*newClear","_*newFrom","_*iota","_*with","_*series","?-prUnarchive","?-asOSCArgArray","?-numChannels","?-asOSCArgBundle","?-envAt","?-poll","?-asSpec","?-unlace","?-deinterlace","?-interlace","?-prUnlace","?-asControlInput","?-scope","?-asUGenInput","?-madd","?-asOSCArgEmbeddedArray" ],
'superclasses': [ "ArrayedCollection","SequenceableCollection","Collection","Object" ],
},
"Classes/Monitor": {
'title': "Monitor",
...
'keywords': [  ],
'related': [  ],
'methods': [ "_*head","_*replace","_*before","_*after","_*tail","_*basicNew","_*new" ],
'superclasses': [ "AbstractGroup","Node","Object" ],
},
"Classes/SampleDur": {
'title': "SampleDur",
