...
'methods': [ "_-wrapExtend","_-asCompileString","_-clipAt","_-stutter","_-foldAt","_-addFirst","_-asRawOSC","_-at","_-clipExtend","_-pyramidg","_-source","_-mirror2","_-asString","_-slice","_-pyramid","_-multiChannelExpand","_-unbubble","_-add","_-containsSeqColl","_-replace","_-deepCollect","_-normalizeSum","_-scramble","_-put","_-mirror1","_-slide","_-wrapPut","_-atIdentityHashInPairs","_-allTuples","_-atIdentityHash","_-foldPut","_-permute","_-addAll","_-powerset","_-flop","_-dpoll","_-mirror","_-envirPairs","_-removeAt","_-rotate","_-size","_-reverse","_-isValidUGenInput","_-insert","_-swap","_-reverseDo","_-foldExtend","_-overWrite","_-plot","_-lace","_-clipPut","_-bubble","_-++","_-windex","_-do","_-collect","_-reshape","_-wrapAt","_-shift","_-fork","_-sputter","_-normalize","_*iota","_*fill","_*geom","_*newFrom","_*series","_*linrand","_*new","_*fillND","_*interpolation","_*rand2","_*fib","_*rand","_*fill2D","_*newClear","_*exprand","_*with","?-prUnarchive","?-asOSCArgArray","?-numChannels","?-asOSCArgBundle","?-envAt","?-poll","?-asSpec","?-unlace","?-deinterlace","?-interlace","?-prUnlace","?-asControlInput","?-scope","?-asUGenInput","?-madd","?-asOSCArgEmbeddedArray" ],
'superclasses': [ "ArrayedCollection","SequenceableCollection","Collection","Object" ],
},
"Classes/Monitor": {
'title': "Monitor",
...
'keywords': [  ],
'related': [  ],
'methods': [ "_*tail","_*new","_*before","_*after","_*head","_*replace","_*basicNew" ],
'superclasses': [ "AbstractGroup","Node","Object" ],
},
"Classes/SampleDur": {
'title': "SampleDur",
