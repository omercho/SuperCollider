...
'keywords': [  ],
'related': [  ],
'methods': [ "?*preSetAll","?*snrT","?*flatT","?*resetCounts","?*hatT","?*ortaT","?*globals","?*setTempo","?*bassT","?*tempo","?*sampT","?*initClass","?*times","?*res1T","?*kickT" ],
'superclasses': [ "Object" ],
},
"Classes/Preceive": {
'title': "Preceive",
...
'methods': [ "_-overWrite","_-do","_-wrapExtend","_-foldAt","_-insert","_-asCompileString","_-replace","_-reshape","_-stutter","_-plot","_-wrapPut","_-clipExtend","_-asRawOSC","_-pyramidg","_-source","_-mirror2","_-deepCollect","_-asString","_-pyramid","_-multiChannelExpand","_-containsSeqColl","_-++","_-foldPut","_-clipAt","_-scramble","_-mirror1","_-slide","_-addAll","_-collect","_-bubble","_-atIdentityHashInPairs","_-allTuples","_-slice","_-atIdentityHash","_-normalize","_-windex","_-unbubble","_-permute","_-flop","_-powerset","_-swap","_-dpoll","_-mirror","_-envirPairs","_-removeAt","_-rotate","_-wrapAt","_-reverse","_-isValidUGenInput","_-put","_-foldExtend","_-normalizeSum","_-addFirst","_-at","_-clipPut","_-lace","_-shift","_-fork","_-size","_-add","_-sputter","_-reverseDo","_*interpolation","_*exprand","_*iota","_*series","_*rand","_*new","_*fill","_*linrand","_*fib","_*newFrom","_*fillND","_*newClear","_*fill2D","_*geom","_*rand2","_*with","?-prUnarchive","?-asOSCArgArray","?-numChannels","?-asOSCArgBundle","?-envAt","?-poll","?-asSpec","?-unlace","?-deinterlace","?-interlace","?-prUnlace","?-asControlInput","?-scope","?-asUGenInput","?-madd","?-asOSCArgEmbeddedArray" ],
'superclasses': [ "ArrayedCollection","SequenceableCollection","Collection","Object" ],
},
"Classes/Monitor": {
'title': "Monitor",
...
'subclasses': [ "GtrReceive","Main1","PlusFreqScopeWindow","PowerOfTwoAllocator","LanguageConfig","JODAKlankReceive","Ia1Pattern","CCBank","Beats","Env","TransBeings1MainSA","BLowPass4","InterplChord","ZKM1Synths","ScopeBuffer","QuarkView","KafesChannels","SimpleController","KafesLayerA","Date","Exception","KeyCodeResponder","ZKM1Groups","PatternConductor","AbstractMDPlugin","IFFlat","SoundFileFormats","Ses1","IFProject","TChoose","CCRespGroup","Decorator","NamedControl","EventStreamCleanup","IFBass","BHiPass4","Globals","TDuty_old","QuarkViewQt","Instr","IFSnr","AbstractNodeWatcher","JODAFlowMic","ControlName","UnicodeResponder","FlowVar","MIDIResponder","Score","SerialPort","MIDIEndPoint","SendTags","GeneralHIDSlot","MethodOverride","LRUNumberAllocator","SoundIn","MIDIChannelIndex","AbstractPlayControl","Puppet","JODAKaos","StackNumberAllocator","IFHat","NodeMapSetting","Scale","Harmonics","VKeys","RthmReceive","PathName","QuarksViewQt","BusPool","ScIDE","QFont","GeneralHIDDeviceGUI","GuiRedirect","Gradient","SelectXFocus","CControl","WiiMoteGUI","Condition","Rect","UGenInstr","SF01Setup","ChRlpf","InstrBrowser","Color","UniqueID","ServerMeter","QOrientation","QWebFontFamily","HIDInfo","History","QWindow","Message","TransBeings1SynthDefs","ZKM1Osc","Quarks","JITGui","Dests","MIDIIn","QColorGroup","HIDDevice","Volume","TransBeings1Buffers","DebugFrame","ScaleStream","ZKM1SynthDefs","Rest","GeneralHIDInfo","SkipJack","NcircGroups","Ia1IndustSA","SCDocNode","Speech","JODANeyDef","IFSamp","RingNumberAllocator","MIDIBufManager","ClientOnTrigResponder","PMOsc","HelpBrowser","ClassBrowser","Kaos","Quark","SimpleKDRUnit","MultiTap","TransBeings1Osc","JODAFlowJer","KafesReceives","ZKM1Buffers","AbstractDispatcher","Ia1PatSA","QMetaObject","KafesLayerC","ScaleInfo","HistoryGui","ContiguousBlock","InBus","SystemSynthDefs","OSCresponder","AutoCompMethodBrowser","NcircFX","LinkedListNode","OSCBundle","Inspector","RespTags","EZScroller","Karcigar","PatchIn","IFRes1","Aut1","AbstractMIDIControl","GridLines","AferesiReceive","AutSynth","QCurve","KafesLoadEngine","KafesMain01","Ia1SynthDefs","PingPong","BeatSched","ChWah","Ableton","Ncircle","Mono","CCAllocator","Cargah","InterplPairs","NetAddr","NcircBusses","PowerOfTwoBlock","GeneralHID","Spec","JODAIndust","HIDDeviceService","PlusFreqScope","EnvGate","KeyCodeResponderStack","IFKeys","VPNoteInfo","SCDoc","AbstractSystemAction","SynthDef","SCDocHTMLRenderer","PriorityQueue","AeisferReceive","PageLayout","JODAReceive","DrawGrid","TuningInfo","DrawGridX","QAlignment","JODAMicPat","Position","Ia1PreIntro","ChReverb","KafesSynthDefs","AbstractMessageMatcher","Tuning","HiliteGradient","PlayerRecorder","KafesPLayers","KlankReceive","Help","Crucial","ControlPrototypes","Enveloper2","NumChannels","URI","XFader","Ia1MainSA","JODATapBuf","MIDIRecBuf","ServerMeterView","VolumeGui","Tempo","IFOrta","MIDIEvent","SlotInspector","QuarkDependency","WiiRemoteGUI","EZGui","Perdeler","SF01Buffers","EventTypesWithCleanup","QColorRole","RastMakam","QtGUI","SF01Busses","Post","WiiMote","ZKM1MainSA","TransBeings1Busses","SpeechChannel","Annotations","OCMIDI","Plotter","NodeProxyEditor","Mix","Baxx","QObject","KafesSpat","MIDISyncClock","PTechno","Module","SplayZ","QuarkSVNRepository","Warp","KafesLayerB","Quant","NodeMap","MIDIChannel","RecordProxyMixer","Buffer","QPen","JODABaxx","NcMainVol","Zirk","Ia1Osc","MIDIClient","JODA","Ia1FxSA","LocalQuarks","IODesc","QLimits","SwitchByKind","Monitor","SCViewHolder","LinLin","XIn","NotificationCenter","NodeControl","RecordInput","Unix","EnvironmentRedirect","XFader4","ModalDialog","OF","ChDelay","TempoBus","Ia1Busses","BufferProxy","SynthDesc","ProxyMixerOld","SynthDescLib","QDialog","ChClean","SoundFile","Updater","Gendai","PrettyState","JODARecs","PatchOut","NcircSDefs","CountRespTags","XInFeedback","XFaderN","InterplXYC","HIDDeviceElement","NcircFXSynths","Sheet","MXHID","Ia1Groups","Avos","Node","NodeIDAllocator","SelectButtonSet","Plot","Document","BusScopeSynth","QStethoscope","QuarksView","WiiNunchukGUI","NotificationRegistration","ContiguousBlockAllocator","MIDIClockOut","Ia1Buffers","GUI","Clock","MIDIPort","SendAmpFreq","KafesGlobals","Bus","PostAllOSC","OSCMidiResponder","Dopfer01Receive","Scheduler","AbstractConsole","IFOSC","IFKick","Editor","QPalette","AbstractConstraint","GeneralHIDSpec","SF01SynthDefs","QKey","Perde","Sipihr","Impulsar","Silent","QC","MXHIDSlot","Server","ProxyMonitorGui","PostAllMIDI","QTreeViewItem","OSCService","MultiChanRecorder","AbstractMIDISocket","ZKM1Busses","Size","TWChoose","Semaphore","QStethoscope2","QKeyModifiers","MethodQuote","InterplEnv","InstrAt","GeneralHIDDevice","ChFlow","KeyDownResponderGroup","WiiMoteIRObject","Point","SCDocEntry","ServerOptions","GraphBuilder","Ses2","WiiCalibrationInfo","HelpSearchResult","Platform","MIDIOut","TestDependant","SelectX","AbstractResponderFunc","ServerShmInterface","RawPointer","Magnitude","Boolean","Nil","Symbol","Finalizer","AbstractFunction","Interpreter","Process","Frame","FunctionDef","Collection","Class" ],
},
"Classes/Pfx": {
'title': "Pfx",
'path': "Classes/Pfx",
...
'keywords': [  ],
'related': [  ],
'methods': [ "?*initClass","?*globals","?*bridge","?*note","?*oct","?*freeAll","?*parts","?*trans","?*main" ],
'superclasses': [ "Object" ],
},
...
'keywords': [  ],
'related': [  ],
'methods': [ "_*after","_*before","_*tail","_*basicNew","_*new","_*head","_*replace" ],
'superclasses': [ "AbstractGroup","Node","Object" ],
},
"Classes/SampleDur": {
'title': "SampleDur",
