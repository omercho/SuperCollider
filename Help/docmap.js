...
'methods': [ "_-deepCollect","_-insert","_-wrapExtend","_-asCompileString","_-stutter","_-do","_-asRawOSC","_-clipExtend","_-pyramidg","_-wrapPut","_-addAll","_-mirror2","_-source","_-asString","_-wrapAt","_-pyramid","_-multiChannelExpand","_-normalize","_-containsSeqColl","_-scramble","_-mirror1","_-put","_-normalizeSum","_-slide","_-bubble","_-windex","_-atIdentityHashInPairs","_-allTuples","_-atIdentityHash","_-foldPut","_-addFirst","_-swap","_-permute","_-foldAt","_-size","_-powerset","_-flop","_-clipAt","_-dpoll","_-slice","_-clipPut","_-mirror","_-envirPairs","_-rotate","_-replace","_-reverse","_-removeAt","_-isValidUGenInput","_-++","_-foldExtend","_-reshape","_-overWrite","_-collect","_-plot","_-lace","_-reverseDo","_-shift","_-add","_-at","_-sputter","_-fork","_-unbubble","_*exprand","_*linrand","_*rand","_*series","_*interpolation","_*new","_*geom","_*newFrom","_*fillND","_*fill2D","_*rand2","_*iota","_*newClear","_*fib","_*fill","_*with","?-prUnarchive","?-asOSCArgArray","?-numChannels","?-asOSCArgBundle","?-envAt","?-poll","?-asSpec","?-unlace","?-deinterlace","?-interlace","?-prUnlace","?-asControlInput","?-scope","?-asUGenInput","?-madd","?-asOSCArgEmbeddedArray" ],
'superclasses': [ "ArrayedCollection","SequenceableCollection","Collection","Object" ],
},
"Classes/Monitor": {
'title': "Monitor",
...
'keywords': [  ],
'related': [  ],
'methods': [ "_*tail","_*after","_*head","_*replace","_*basicNew","_*before","_*new" ],
'superclasses': [ "AbstractGroup","Node","Object" ],
},
"Classes/SampleDur": {
'title': "SampleDur",
