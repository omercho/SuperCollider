...
'methods': [ "_-wrapExtend","_-asCompileString","_-stutter","_-normalize","_-swap","_-asRawOSC","_-bubble","_-clipExtend","_-at","_-pyramidg","_-mirror2","_-clipPut","_-source","_-asString","_-pyramid","_-multiChannelExpand","_-containsSeqColl","_-deepCollect","_-scramble","_-mirror1","_-slide","_-put","_-atIdentityHashInPairs","_-plot","_-allTuples","_-add","_-atIdentityHash","_-slice","_-permute","_-flop","_-powerset","_-wrapAt","_-removeAt","_-dpoll","_-windex","_-mirror","_-normalizeSum","_-envirPairs","_-overWrite","_-foldPut","_-clipAt","_-replace","_-addFirst","_-size","_-++","_-unbubble","_-reverse","_-rotate","_-reverseDo","_-do","_-isValidUGenInput","_-addAll","_-wrapPut","_-foldAt","_-foldExtend","_-reshape","_-lace","_-insert","_-shift","_-fork","_-sputter","_-collect","_*series","_*fib","_*fillND","_*rand2","_*new","_*linrand","_*geom","_*rand","_*fill","_*iota","_*newClear","_*interpolation","_*fill2D","_*exprand","_*with","_*newFrom","?-prUnarchive","?-asOSCArgArray","?-numChannels","?-asOSCArgBundle","?-envAt","?-poll","?-asSpec","?-unlace","?-deinterlace","?-interlace","?-prUnlace","?-asControlInput","?-scope","?-asUGenInput","?-madd","?-asOSCArgEmbeddedArray" ],
'superclasses': [ "ArrayedCollection","SequenceableCollection","Collection","Object" ],
},
"Classes/Monitor": {
'title': "Monitor",
...
'keywords': [  ],
'related': [  ],
'methods': [ "_*before","_*replace","_*head","_*basicNew","_*new","_*after","_*tail" ],
'superclasses': [ "AbstractGroup","Node","Object" ],
},
"Classes/SampleDur": {
'title': "SampleDur",
