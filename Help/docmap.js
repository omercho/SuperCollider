...
'methods': [ "_-wrapExtend","_-asCompileString","_-addFirst","_-stutter","_-asRawOSC","_-clipExtend","_-size","_-pyramidg","_-source","_-mirror2","_-asString","_-pyramid","_-multiChannelExpand","_-add","_-containsSeqColl","_-replace","_-deepCollect","_-scramble","_-mirror1","_-slide","_-atIdentityHashInPairs","_-clipAt","_-allTuples","_-foldPut","_-atIdentityHash","_-wrapAt","_-permute","_-flop","_-powerset","_-reverseDo","_-reshape","_-dpoll","_-mirror","_-envirPairs","_-clipPut","_-at","_-rotate","_-do","_-collect","_-reverse","_-foldAt","_-isValidUGenInput","_-removeAt","_-addAll","_-normalize","_-++","_-foldExtend","_-wrapPut","_-insert","_-plot","_-put","_-lace","_-shift","_-fork","_-sputter","_-normalizeSum","_-swap","_-windex","_*exprand","_*geom","_*rand","_*fillND","_*new","_*series","_*iota","_*newFrom","_*fill","_*linrand","_*fib","_*newClear","_*fill2D","_*interpolation","_*with","_*rand2","?-prUnarchive","?-proxyControlClass","?-numChannels","?-asAudioRateInput","?-envAt","?-poll","?-asSpec","?-unlace","?-deinterlace","?-interlace","?-prUnlace","?-asControlInput","?-scope","?-asUGenInput","?-madd","?-buildForProxy" ],
'superclasses': [ "ArrayedCollection","SequenceableCollection","Collection","Object" ],
},
"Classes/Monitor": {
'title': "Monitor",
...
'keywords': [  ],
'related': [  ],
'methods': [ "_*new","_*before","_*head","_*basicNew","_*after","_*tail","_*replace" ],
'superclasses': [ "AbstractGroup","Node","Object" ],
},
"Classes/SampleDur": {
'title': "SampleDur",
