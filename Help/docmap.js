...
'methods': [ "_-wrapExtend","_-insert","_-replace","_-unbubble","_-asCompileString","_-stutter","_-asRawOSC","_-clipExtend","_-clipAt","_-bubble","_-pyramidg","_-mirror2","_-source","_-asString","_-pyramid","_-multiChannelExpand","_-foldAt","_-containsSeqColl","_-clipPut","_-scramble","_-add","_-wrapAt","_-mirror1","_-slide","_-slice","_-atIdentityHashInPairs","_-foldPut","_-allTuples","_-addAll","_-atIdentityHash","_-permute","_-flop","_-collect","_-powerset","_-at","_-++","_-dpoll","_-mirror","_-overWrite","_-envirPairs","_-rotate","_-reshape","_-windex","_-reverse","_-isValidUGenInput","_-reverseDo","_-deepCollect","_-normalize","_-foldExtend","_-swap","_-plot","_-wrapPut","_-lace","_-put","_-shift","_-removeAt","_-normalizeSum","_-addFirst","_-fork","_-sputter","_-do","_-size","_*interpolation","_*series","_*fillND","_*exprand","_*fill2D","_*linrand","_*new","_*iota","_*rand","_*fill","_*fib","_*newClear","_*rand2","_*geom","_*with","_*newFrom","?-prUnarchive","?-asOSCArgArray","?-numChannels","?-asOSCArgBundle","?-envAt","?-poll","?-asSpec","?-unlace","?-deinterlace","?-interlace","?-prUnlace","?-asControlInput","?-scope","?-asUGenInput","?-madd","?-asOSCArgEmbeddedArray" ],
'superclasses': [ "ArrayedCollection","SequenceableCollection","Collection","Object" ],
},
"Classes/Monitor": {
'title': "Monitor",
...
'keywords': [  ],
'related': [  ],
'methods': [ "_*after","_*new","_*tail","_*replace","_*basicNew","_*head","_*before" ],
'superclasses': [ "AbstractGroup","Node","Object" ],
},
"Classes/SampleDur": {
'title': "SampleDur",
